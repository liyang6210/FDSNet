...
class MixVisionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.norm1(x)
        print("11111xx", x.shape)

        x = self.se1(x)
        print('se1',x[1].shape)

        outSe.append(x[0].reshape(B, H, W, -1).permute(0, 3, 1, 2).contiguous())
...
class SegFormer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        print('----------------')
        print(seResult[1].shape,seResult[2].shape)
        ...
        print(seResult[0].shape,seResult[1].shape)
