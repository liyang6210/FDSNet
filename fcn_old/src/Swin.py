...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        result = []
        print(selected_layers_output[0].shape,selected_layers_output[1].shape,selected_layers_output[2].shape,selected_layers_output[3].shape)
...
def vit_base_patch16_224_in21k(num_classes: int = 21843, has_logits: bool = True):
    ...
    model = deeplabv3_resnet101(num_classes=104)
    return model
